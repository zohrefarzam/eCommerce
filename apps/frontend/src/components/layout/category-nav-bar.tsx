...
import { categoryBarItems } from "@/content/landing";
...
export function CategoryNavBar() {
  return (
    <nav
      ...
      className="flex w-full flex-nowrap gap-0 overflow-x-auto bg-category-bar-bg py-3 text-white sm:overflow-visible"
    >
